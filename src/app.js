...
import { componentData, languages } from './content'; // Removed initialContent, added languages
...
const App = () => {
  ...
  // Initialize content state using languages from content.js
  ...
  const SiderMenu = (
    ...
    >
      ...
      {/* <Menu.ItemGroup key="g3" title={t.dataDisplay}>
            ...
            <Menu.Item key="avatar">{t.avatar}</Menu.Item> // Duplicate, should be removed
