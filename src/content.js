...
import ProductionManagementDashboard from "./components/demos/ProductionManagementDashboard";
...
export const componentData = {
    ...
    productionManagement: {
        demo: <ProductionManagementDashboard />,
        code: `import { Card, Table, Input, DatePicker, Button, Tag, Row, Col, Statistic } from 'antd';`,
    },
    // Data Entry
...
export const initialContent = {
    en: {
        ...
        productionManagement: 'Production Management Dashboard',
        productionManagementDescription: 'A dashboard for managing orders, inventory, and logistics in agricultural production.',
...
`,
    ...
    zh: {
        ...
        tree: '树形控件',
        typography: '排版',
        productionManagement: '生产管理仪表板',
        productionManagementDescription: '用于管理农业生产中的订单、库存和物流的仪表板。',
