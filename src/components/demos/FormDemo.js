            ...
            >
                <div style={{ background: 'linear-gradient(90deg, rgba(79, 161, 71, 0.10) 0%, rgba(69, 99, 191, 0.10) 100%)', padding: '16px 24px' }}>
                    <Row justify="space-between" align="middle">
                        ...
                        <Col><Button type="text" icon={<CloseOutlined />} onClick={handleCancel} /></Col>
                    </Row>
                </div>
                <div style={{ padding: '24px', background: '#FFFFFF', maxHeight: '65vh', overflowY: 'auto' }}>
                    <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ items: [{ product: 'Soybeans - Premium Grade', quantity: 1000 }] }}>
                        <Row gutter={24}>
                            <Col xs={24} sm={12} lg={8}><Form.Item label={t.orderNumber}><Input value={t.autoGenerated} disabled /></Form.Item></Col>
                            <Col xs={24} sm={12} lg={8}><Form.Item name="customer" label={t.customer} rules={[{ required: true }]}><Select placeholder={t.pleaseSelect}><Option value="cust1">Customer A</Option></Select></Form.Item></Col>
                            <Col xs={24} sm={12} lg={8}><Form.Item name="plannedDeliveryDate" label={t.plannedDelivery} rules={[{ required: true }]}><DatePicker style={{ width: '100%' }} placeholder={t.selectDate} /></Form.Item></Col>
                            <Col xs={24} sm={12} lg={8}><Form.Item name="deliveryPurpose" label={t.deliveryPurpose} rules={[{ required: true }]}><Select placeholder={t.selectPurpose}><Option value="comm">Commercial</Option></Select></Form.Item></Col>
                            <Col xs={24} sm={12} lg={5}><Form.Item name="orderRemarks" label={t.orderRemarks}><Select placeholder={t.pleaseSelect} suffixIcon={<EditOutlined />}><Option value="1">Remark 1</Option></Select></Form.Item></Col>
                            <Col xs={24} sm={12} lg={5}><Form.Item name="priorityLevel" label={t.priorityLevel}><Select defaultValue="normal"><Option value="normal">Normal Priority</Option></Select></Form.Item></Col>
                            <Col xs={24} sm={12} lg={6}><Form.Item name="farmLocation" label={t.farmLocation} rules={[{ required: true }]}><Select placeholder={t.selectFarm}><Option value="loc1">Farm Location 1</Option></Select></Form.Item></Col>
                        </Row>
